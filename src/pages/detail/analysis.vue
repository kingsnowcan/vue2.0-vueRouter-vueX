    ...
    <div class="sales-board-intro">
      ...
      <div class="sales-board-form">
          ...
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                <v-selection :selections = "productTypes" @on-change="onParamChange('proType', $event)"></v-selection>
          ...
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                <v-chooser :selections="chooserList" @on-change="onParamChange('period', $event)"></v-chooser>
                 <!--  <v-chooser
