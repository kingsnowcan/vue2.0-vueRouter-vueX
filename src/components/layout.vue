    ...
    <div class="head-nav">
         <ul class="nav-list">
              ...
              <!-- <li v-if="username!==''" class="nav-pile">|</li>   -->                      
               <li v-if="username===''" @click="loginBtn">登录</li> 
               <li class="nav-pile">|</li>   
                <li v-if="username!==''">退出</li>            
              <li @click="regisBtn" v-if="username===''">注册</li>
              <li class="nav-pile">|</li>
              <li @click="aboutBtn">关于</li>
         </ul>
    </div>
  </div>
</div>
